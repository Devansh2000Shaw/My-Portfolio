...
function Contact() {
  ...
  return (
    <div>
      <p className="why" id="Contact" style={{ fontFamily: "Ubuntu" }}>
        .contact()
      </p>
      ...
      <div id="contact" className="contact-us section">
        <div className="container">
          <div className="row">
            <div
              className="col-lg-6 contact-wrapper align-self-center wow"
              data-aos="fade-up"
              style={{ marginTop: "0px" }}
            >
              ...
              <div className="footer-item footer-contact">
                ...
                >
                  <img
                    ...
                    alt="location"
                  />{" "}
                  <span style={{ paddingLeft: "10px" }}> Kolkata, India </span>
                </p>
                <br />
                <a
                  href="mailto:akashshaw8783@gmail.com"
                  style={{
                    marginBottom: "0px",
                    color: "white",
                    fontSize: "22px",
                ...
                >
                  <img src={Email} height="30px" alt="email" width="30px" />{" "}
                  <span style={{ paddingLeft: "10px" }}>
                    {" "}
                    akashshaw8783@gmail.com{" "}
                  </span>
                </a>
                <br />
                ...
                <a href="https://github.com/Devansh2000Shaw">
                ...
                >
                  {" "}
                  Copyright © {currYear} | All Rights Reserved <hr /> Made with{" "}
                  <img src={Love} alt="love" height="40px" width="40px" /> and{" "}
                  <img src={Music} alt="music" height="40px" width="40px" /> by
                  Devansh Shaw
                </p>
