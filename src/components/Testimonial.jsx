...
function Testimonial(){
    return(
        <div id="recommendation">
            <p style = {{marginBottom: "50px", fontFamily: "Ubuntu"}} className = "skill" >.recommendations()</p>
            <div>
            ...
            <div id="carousel1" className="carousel slide testimonial-style" data-ride="carousel">
              ...
              <div className="carousel-inner">
                <div className="item active">
                  <div className="carousel-caption testimonial-caption-style">
                    ...
                    <p style = {{color: "white", marginTop: "50px" , fontFamily: "Ubuntu"}}> <i className="fa fa-quote-left" aria-hidden="true" style = {{color: "#EAA023", marginRight: "5px"}}></i>
              ...
              {/* Controls */}
              <br/><br/>
              <a className="left carousel-control lf" href="#carousel1" data-slide="prev"> <span className="glyphicon glyphicon-chevron-left"></span> </a>
              <a className="right carousel-control rf" href="#carousel1" data-slide="next"> <span className="glyphicon glyphicon-chevron-right"></span> </a>
            </div>
        </div>
    );
}
