...
function Intro() {
  ...
  return (
    <div id="intro">
      <p class="why" style={{ fontFamily: "Ubuntu" }}>
        {" "}
        .about(){" "}
      </p>
      <br />
            ...
            <div class="col-lg-6 order-lg-1" data-aos="fade-right">
              <div class="tours__item__text">
                ...
                <div class="tours__text__desc">
                  ...
                  >
                    I’m Devansh, a Final year B.Tech CSE, undergraduate student
                    at Kalinga Institute of Industrial Technology, BBSR, India.
                    🎓 I'm a passionate full-stack web developer and a
                    competitive coder. If I talk about my professional
                    experience, I've interned at a couple of reputed firms and
                    have indepth knowledge about developing products.. Apart
                    from this, I love being part of different communities and
                    engaging myself in different community works. Some of the
                    technologies and tools used by me include <span></span>
                    <span style={{ color: "rgb(59, 216, 245)" }}>ReactJS</span>,
                    <span></span>
                    <span> Next.js</span>, <span></span>
                    <span style={{ color: "rgb(255, 166, 17)" }}>
                      {" "}
                      Firebase
                    </span>
                    ,<span></span>
                    <span style={{ color: "rgb(118, 74, 188)" }}> Redux</span>,
                    <span></span>
            ...
            <div className="col-lg-6 order-lg-2" data-aos="fade-left">
              <div className="tours__item__pic">
                ...
                >
                  ...
                  <div className="carousel-inner-intro">
