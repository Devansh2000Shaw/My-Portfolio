        ...
        <div id = "project" style = {{marginBottom: "-20px"}}>
            ...
            <div className="row">
                <div className="image1 animate__animated animate__backInUp"  id = "click1">
                    <img alt="images" src="img 1.jpeg" onClick={displayFlex1} className="image1" />
                </div>
                <div className="image3 animate__animated animate__backInRight">
                    <img alt="images" src="img 3.jpeg" onClick={displayFlex3} className="image3" />
                </div>
            </div>
                {/* <!-- POPUP --> */}
                <div className="bg-modal1">
                    <div class="modal-content1">
                        <div id="popup_top_image1">
                            <div className="cross">
                                <div className="list-item" onClick={displayNone1} ><img alt="images" src="cross.png" className="fa-times"/></div>
                            </div>
                        </div>
                        <div class="popup_card">
                            <div>
                                <a href="https://github.com/GFG-CLUB-KIIT/" target="_blank" rel="noopener noreferrer"><img alt="images" src="github.png" id="popup_card_github" /></a>
                            ...
                            <div class="popup_card_bottom">
                                ...
                                <img alt="images" src="phython.png" class="popup_card_bottom_lang_logo" title="Phython" />
                            </div>
                        </div>
                ...
                <div className="bg-modal3">
                    <div class="modal-content3">
                        <div id="popup_top_image2">
                            <div className="cross">
                                <div className="list-item" onClick={displayNone3} ><img alt="images" src="cross.png" className="fa-times"/></div>
                            </div>
                        </div>
                        <div class="popup_card1">
                            ...
                            <lable class="popup_bottom_lang">Language Used:</lable> 
                                <img alt="images" src="html.png" class="popup_bottom_lang_logo" title="HTML" />
                                <img alt="images" src="css.png" class="popup_bottom_lang_logo" title="CSS" />
                                <img alt="images" src="javascript.png" class="popup_bottom_lang_logo" title="JavaScript" /><br/>
                            <lable class="popup_bottom_frame">Framework Used:</lable>
                                <img alt="images" src="react.png" class="popup_bottom_lang_logo reactlogo" title="React" />
                            </div>
                        </div>
                        <div class="popup-context">
